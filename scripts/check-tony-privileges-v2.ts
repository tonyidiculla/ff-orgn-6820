...
async function checkTonyPrivileges() {
    ...
    if (!assignments || assignments.length === 0) {
        ...
        console.log(`
INSERT INTO public.user_to_role_assignment (user_platform_id, platform_role_id, is_active)
VALUES (
  '${profile.user_platform_id}',
  (SELECT id FROM public.platform_roles WHERE role_name = 'platform_admin' LIMIT 1),
  true
);`)
        return
    }
