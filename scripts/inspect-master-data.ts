...
async function inspectMasterData() {
    console.log('🔍 Inspecting public schema contents...\n')
    ...
    if ((count || 0) === 0) {
        console.log('\n💡 Your public schema appears to be empty.')
        console.log('   You may need to import the data from public_dump.sql.bkp')
    }
}
