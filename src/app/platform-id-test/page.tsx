    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-sky-50 via-white to-emerald-100 p-8">
            <div className="mx-auto max-w-4xl">
                ...
                {/* Live Test Input */}
                <div className="mb-8 rounded-2xl border border-white/70 bg-white/60 p-6 shadow-xl backdrop-blur">
                ...
                <div className="grid gap-6 md:grid-cols-2">
                    {/* Valid IDs */}
                    <div className="rounded-2xl border border-white/70 bg-white/60 p-6 shadow-xl backdrop-blur">
                ...
                {/* Documentation */}
                <div className="mt-8 rounded-2xl border border-white/70 bg-white/60 p-6 shadow-xl backdrop-blur">
