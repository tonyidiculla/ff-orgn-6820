    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (!refreshError && refreshedEntityData) {
                ...
                // Update selected modules state with refreshed data
                if (refreshedEntityData.subscribed_modules && Array.isArray(refreshedEntityData.subscribed_modules)) {
                    const refreshedModuleIds = refreshedEntityData.subscribed_modules.map((m: any) => m.module_id)
