...
export default function HospitalEntityCreation() {
    ...
    useEffect(() => {
        async function fetchModules() {
            ...
            console.log('   Query: SELECT * FROM public.modules_master')
            ...
            try {
                ...
                if (allModules && allModules.length > 0) {
                    ...
                    console.warn('   ⚠️ No modules found in public.modules_master table at all!')
                }
            } catch (err) {
            ...
            try {
                ...
                if (!data || data.length === 0) {
                    ...
                    console.warn('   1. modules_master table is empty')
