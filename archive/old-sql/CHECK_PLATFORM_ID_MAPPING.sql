...
SELECT 
    ...
    type_description,
    is_active
FROM public.platform_id_mapping
WHERE category_code = 'C'
ORDER BY type_code;

-- If you need to update the mapping table to have C00 instead of C01/C02:
-- 
-- DELETE FROM public.platform_id_mapping WHERE category_code = 'C' AND type_code IN ('01', '02');
-- 
-- INSERT INTO public.platform_id_mapping (
--     category_code, 
--     category_name, 
